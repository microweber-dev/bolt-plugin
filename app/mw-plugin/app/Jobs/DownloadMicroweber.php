...
class DownloadMicroweber implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $shellPath = '/usr/local/bolt/plugins/microweber/app/mw-plugin/vendor/microweber-packages/shared-server-scripts/shell-scripts';
        shell_exec('chmod +x ' . $shellPath . '/*');

        $mwComposerClientHelper = new \App\MicroweberComposerClientHelper();
